...
interface Meta {
  ...
  recipientTypes: { value: "counselor" | "teacher" | "cadre"; label: string }[];
        ...
        {successLabel ? (
          ...
          <div className="card p-7 sm:p-9 fade-in">
            ...
            <form onSubmit={submit} className="mt-7 space-y-6">
              <div>
                <label className="label">这条建议希望谁看到？</label>
                <div className="segmented">
                  {(meta?.recipientTypes ?? [
                    ...
                    <button
                      type="button"
                      key={r.value}
                      className={recipientType === r.value ? "active" : ""}
                ...
                <div key={s.id} className="card p-5 fade-in">
                  <div className="flex items-center gap-2 flex-wrap mb-2">
                    <span className="chip chip-purple">
                      {RECIPIENT_TYPE_LABELS[s.recipientType] ?? s.recipientType}
                    </span>
